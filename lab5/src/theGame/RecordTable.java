...
public class RecordTable {
    ...
    private RecordTable() throws IOException {}
    public static void rewriteFile(String path, Vector<Vector<String>> strs) throws IOException {
        RecordTable rt = new RecordTable();
        rt.fileName = path;
        for (Vector<String> cur : strs)
            rt.set(cur.elementAt(0), cur.elementAt(1), cur.elementAt(2));
        rt.updateFile();
    }
}
